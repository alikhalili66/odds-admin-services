...
import ir.khalili.products.odds.core.routemanager.competition.RtMgr_06_CompetitionGroupFetch;
...
import ir.khalili.products.odds.core.verticle.competition.VRTCL_06_CompetitionGroupFetch;
...
public class EntryPoint extends AbstractVerticle {
    ...
    private static void deployVerticle() {
    	...
    	vertx.deployVerticle(VRTCL_06_CompetitionGroupFetch.class.getName());
    ...
    public void start(Promise<Void> startPromise) throws Exception {
        ...
        //COMPETITION
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_01_CompetitionSave							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_02_CompetitionUpdate							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_03_CompetitionDelete							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_04_CompetitionFetchAll							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_05_CompetitionFetchById							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_06_CompetitionGroupFetch							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_07_CompetitionQuestionAssign							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_08_CompetitionQuestionUnAssign							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_09_CompetitionQuestionFetch							:: handler);
    	
		//FOLDER
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_01_FolderSave							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_02_FolderUpdate							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_03_FolderDelete							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_04_FolderFetchAll							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_05_FolderFetchById							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_06_FolderQuestionAssign							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_07_FolderQuestionUnAssign							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_08_FolderQuestionFetch							:: handler);
    	
		//GROUP
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_01_GroupSave							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_02_GroupUpdate							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_03_GroupDelete							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_04_GroupFetchAll							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_05_GroupFetchById							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_06_GroupTeamAssign							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_07_GroupTeamUnAssign							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_08_GroupTeamFetch							:: handler);
    	
		//LEAGUE
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_01_LeagueSave							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_02_LeagueUpdate							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_03_LeagueDelete							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_04_LeagueFetchAll							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_05_LeagueFetchById							:: handler);
    	...
    	//QUESTION
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_01_QuestionSave							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_02_QuestionUpdate							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_03_QuestionDelete							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_04_QuestionFetchAll							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_05_QuestionFetchById							:: handler);
    	
    	//TEAM
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_01_TeamSave							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_02_TeamUpdate							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_03_TeamDelete							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_04_TeamFetchAll							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_05_TeamFetchById							:: handler);
    	
		//USER
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_01_UserFetchAll							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_02_UserFetchById							:: handler);
        router.post		("/v1/service/nas/customer/service/otp")				.handler(RtMgr_03_UserFetchOdds							:: handler);
