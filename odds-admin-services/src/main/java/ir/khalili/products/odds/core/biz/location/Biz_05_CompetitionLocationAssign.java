...
public class Biz_05_CompetitionLocationAssign {

    private static final Logger logger = LogManager.getLogger(Biz_05_CompetitionLocationAssign.class);
    ...
    public static void questionAssign(SQLConnection sqlConnection, JsonObject message, Handler<AsyncResult<JsonObject>> resultHandler) {
        ...
        DAO_Location.assignLocation(sqlConnection, message).onComplete(handler -> {
            if (handler.failed()) {
