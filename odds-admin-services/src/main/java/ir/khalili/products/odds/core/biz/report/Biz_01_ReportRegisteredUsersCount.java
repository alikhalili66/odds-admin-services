...
public class Biz_01_ReportRegisteredUsersCount {

    private static final Logger logger = LogManager.getLogger(Biz_01_ReportRegisteredUsersCount.class);
    ...
    public static void fetchRegisteredUsersCount(SQLConnection sqlConnection, JsonObject message, Handler<AsyncResult<JsonObject>> resultHandler) {
        ...
        DAO_Report.fetchRegisteredUsersCount(sqlConnection).onComplete(result -> {
            if (result.failed()) {
