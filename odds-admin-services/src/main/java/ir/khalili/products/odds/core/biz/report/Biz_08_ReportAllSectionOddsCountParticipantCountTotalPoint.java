...
public class Biz_08_ReportAllSectionOddsCountParticipantCountTotalPoint {
    ...
    public static void fetchReportAllSectionOddsCountParticipantCountTotalPoint(SQLConnection sqlConnection, JsonObject message, Handler<AsyncResult<JsonObject>> resultHandler) {
