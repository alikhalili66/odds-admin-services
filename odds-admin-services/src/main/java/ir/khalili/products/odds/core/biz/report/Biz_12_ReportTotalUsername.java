...
public class Biz_12_ReportTotalUsername {

    private static final Logger logger = LogManager.getLogger(Biz_12_ReportTotalUsername.class);
    ...
    public static void fetchReport(SQLConnection sqlConnection, JsonObject message, Handler<AsyncResult<JsonObject>> resultHandler) {
        ...
        Future<List<JsonObject>>  futUsername = DAO_Report.fetchReportUsername(sqlConnection, leagueId);
        
        CompositeFuture.join(Arrays.asList(futUsername)).onComplete(joinHandler01->{
