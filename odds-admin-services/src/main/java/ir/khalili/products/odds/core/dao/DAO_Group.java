...
public class DAO_Group {
    ...
    public static Future<List<JsonObject>> fetchAll(SQLConnection sqlConnection) {
        ...
        sqlConnection.query("SELECT "
        		...
        		+ "g.LEAGUE_ID,"
        		+ "g.NAME,"
        		+ "To_Char(g.ACTIVEFROM,'YYYY/MM/DD\"T\"HH24:MI:SS.ss\"Z\"') ACTIVE_FROM,"
        		+ "To_Char(g.ACTIVETO,'YYYY/MM/DD\"T\"HH24:MI:SS.ss\"Z\"') ACTIVE_TO,"
        		+ "To_Char(g.creationdate,'YYYY/MM/DD\"T\"HH24:MI:SS.ss\"Z\"') creation_date"
