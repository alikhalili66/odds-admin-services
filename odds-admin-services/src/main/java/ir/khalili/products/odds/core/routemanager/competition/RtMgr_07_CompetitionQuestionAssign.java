 ...
 * @author A.KH
 */
public class RtMgr_07_CompetitionQuestionAssign   {
	
	private static								Logger 			logger 								= LogManager.getLogger(RtMgr_07_CompetitionQuestionAssign.class);
	
	public static void handler(RoutingContext context) {
		
		CompetitionInputValidationUtil.validateQuestionAssign(context, validateHandler->{
			...
			context.vertx().eventBus().request(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_COMPETITION_QUESTION_ASSIGN, validateHandler.result(),replyHandler->{
