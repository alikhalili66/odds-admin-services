 ...
 * @author A.KH
 */
public class RtMgr_06_GroupTeamAssign   {
	
	private static								Logger 			logger 								= LogManager.getLogger(RtMgr_06_GroupTeamAssign.class);
	
	public static void handler(RoutingContext context) {
		
		GroupInputValidationUtil.validateTeamAssign(context, validateHandler->{
			...
			context.vertx().eventBus().request(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_GROUP_TEAM_ASSIGN, validateHandler.result(),replyHandler->{
