 ...
 * @author A.KH
 */
public class RtMgr_08_GroupTeamFetch   {
	
	private static								Logger 			logger 								= LogManager.getLogger(RtMgr_08_GroupTeamFetch.class);
	
	public static void handler(RoutingContext context) {
		
		GroupInputValidationUtil.validateTeamFetch(context, validateHandler->{
			...
			context.vertx().eventBus().request(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_GROUP_TEAM_FETCH, validateHandler.result(),replyHandler->{
