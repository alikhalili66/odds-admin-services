 ...
 * @author A.KH
 */
public class RtMgr_02_LeagueUpdate   {
	
	private static								Logger 			logger 								= LogManager.getLogger(RtMgr_02_LeagueUpdate.class);
	
	public static void handler(RoutingContext context) {
		
		LeagueInputValidationUtil.validateUpdate(context, validateHandler->{
			...
			context.vertx().eventBus().request(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_LEAGUE_UPDATE, validateHandler.result(),replyHandler->{
