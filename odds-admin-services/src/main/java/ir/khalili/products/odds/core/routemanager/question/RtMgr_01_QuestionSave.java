 ...
 * @author A.KH
 */
public class RtMgr_01_QuestionSave   {
	
	private static								Logger 			logger 								= LogManager.getLogger(RtMgr_01_QuestionSave.class);
	
	public static void handler(RoutingContext context) {
		
		QuestionInputValidationUtil.validateSave(context, validateHandler->{
			...
			context.vertx().eventBus().request(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_QUESTION_SAVE, validateHandler.result(),replyHandler->{
