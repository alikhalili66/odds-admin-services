 ...
 * @author A.KH
 */
public class RtMgr_04_QuestionFetchAll   {
	
	private static								Logger 			logger 								= LogManager.getLogger(RtMgr_04_QuestionFetchAll.class);
	...
	public static void handler(RoutingContext context) {
		...
		QuestionInputValidationUtil.validateFetchAll(context, validateHandler->{
			...
			context.vertx().eventBus().request(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_QUESTION_ALL_FETCH, validateHandler.result(),replyHandler->{
