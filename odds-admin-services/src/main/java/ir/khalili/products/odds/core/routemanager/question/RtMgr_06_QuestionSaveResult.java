package ir.khalili.products.odds.core.routemanager.question;
 ...
 * Time: 3:03 PM
 */
public class RtMgr_06_QuestionSaveResult {

    private static Logger logger = LogManager.getLogger(RtMgr_06_QuestionSaveResult.class);

    public static void handler(RoutingContext context) {

        QuestionInputValidationUtil.validateFetchAll(context, validateHandler->{
            ...
            context.vertx().eventBus().request(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_QUESTION_SAVE_RESULT, validateHandler.result(), replyHandler->{
