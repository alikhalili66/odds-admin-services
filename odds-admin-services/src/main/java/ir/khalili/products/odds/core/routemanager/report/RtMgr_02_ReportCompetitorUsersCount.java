 ...
 * @author A.KH
 */
public class RtMgr_02_ReportCompetitorUsersCount   {
	
	private static								Logger 			logger 								= LogManager.getLogger(RtMgr_02_ReportCompetitorUsersCount.class);
	
	public static void handler(RoutingContext context) {
		
		ReportInputValidationUtil.validateCompetitorUsersCount(context, validateHandler->{
			...
			context.vertx().eventBus().request(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_REPORT_COMPETITOR_USERS_COUNT, validateHandler.result(),replyHandler->{
