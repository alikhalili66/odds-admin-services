 ...
 * @author A.KH
 */
public class RtMgr_03_ReportCompetitorUsersAmount   {
	
	private static								Logger 			logger 								= LogManager.getLogger(RtMgr_03_ReportCompetitorUsersAmount.class);
	
	public static void handler(RoutingContext context) {
		
		ReportInputValidationUtil.validateCompetitorUsersAmount(context, validateHandler->{
			...
			context.vertx().eventBus().request(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_REPORT_COMPETITOR_USERS_AMOUNT, validateHandler.result(),replyHandler->{
