 ...
 * @author A.KH
 */
public class RtMgr_05_ReportCalculateCompetition   {
	
	private static								Logger 			logger 								= LogManager.getLogger(RtMgr_05_ReportCalculateCompetition.class);
	
	public static void handler(RoutingContext context) {
		
		ReportInputValidationUtil.validateReportCalculateCompetition(context, validateHandler->{
			...
			context.vertx().eventBus().request(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_REPORT_CALCULATE_COMPETITION, validateHandler.result(),replyHandler->{
