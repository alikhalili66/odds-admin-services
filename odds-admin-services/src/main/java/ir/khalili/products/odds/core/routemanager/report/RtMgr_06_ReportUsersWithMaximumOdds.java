 ...
 * @author A.KH
 */
public class RtMgr_06_ReportUsersWithMaximumOdds   {
	
	private static								Logger 			logger 								= LogManager.getLogger(RtMgr_06_ReportUsersWithMaximumOdds.class);
	
	public static void handler(RoutingContext context) {
		
		ReportInputValidationUtil.validateUsersWithMaximumOdds(context, validateHandler->{
