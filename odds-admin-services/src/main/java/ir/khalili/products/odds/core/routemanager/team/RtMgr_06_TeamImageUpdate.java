 ...
 * @author A.KH
 */
public class RtMgr_06_TeamImageUpdate   {
	
	private static								Logger 			logger 								= LogManager.getLogger(RtMgr_06_TeamImageUpdate.class);
	
	public static void handler(RoutingContext context) {
		
		TeamInputValidationUtil.validateImageUpdate(context, validateHandler->{
			...
			context.vertx().eventBus().request(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_TEAM_IMAGE_UPDATE, validateHandler.result(),replyHandler->{
