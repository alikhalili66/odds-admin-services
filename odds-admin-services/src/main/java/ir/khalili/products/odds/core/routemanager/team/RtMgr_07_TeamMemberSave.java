 ...
 * @author A.KH
 */
public class RtMgr_07_TeamMemberSave   {
	
	private static								Logger 			logger 								= LogManager.getLogger(RtMgr_07_TeamMemberSave.class);
	
	public static void handler(RoutingContext context) {
		
		TeamInputValidationUtil.validateMemberSave(context, validateHandler->{
			...
			context.vertx().eventBus().request(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_TEAM_MEMBER_SAVE, validateHandler.result(),replyHandler->{
