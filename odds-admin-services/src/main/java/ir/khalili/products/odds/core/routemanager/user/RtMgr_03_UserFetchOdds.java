 ...
 * @author A.KH
 */
public class RtMgr_03_UserFetchOdds   {
	
	private static								Logger 			logger 								= LogManager.getLogger(RtMgr_03_UserFetchOdds.class);
	
	public static void handler(RoutingContext context) {
		
		UserInputValidationUtil.validateFetchOdds(context, validateHandler->{
			...
			context.vertx().eventBus().request(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_USER_ODDS_FETCH, validateHandler.result(),replyHandler->{
