...
import ir.khalili.products.odds.core.biz.auth.Biz_01_AuthLogin;
import ir.khalili.products.odds.core.constants.AppConstants;
import ir.khalili.products.odds.core.utils.Configuration;

public class VRTCL_01_AuthLogin extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_01_AuthLogin.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_AUTH_LOGIN, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_AUTH_LOGIN+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
		    		...
		    		Biz_01_AuthLogin.doAuth(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_AUTH_LOGIN+" ready to reply.");
