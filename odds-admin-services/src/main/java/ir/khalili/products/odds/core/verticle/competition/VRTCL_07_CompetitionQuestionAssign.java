...
import ir.khalili.products.odds.core.biz.competition.Biz_07_CompetitionQuestionAssign;
import ir.khalili.products.odds.core.constants.AppConstants;
import ir.khalili.products.odds.core.utils.Configuration;

public class VRTCL_07_CompetitionQuestionAssign extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_07_CompetitionQuestionAssign.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_COMPETITION_QUESTION_ASSIGN, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_COMPETITION_QUESTION_ASSIGN+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_07_CompetitionQuestionAssign.questionAssign(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_COMPETITION_QUESTION_ASSIGN+" ready to reply.");
