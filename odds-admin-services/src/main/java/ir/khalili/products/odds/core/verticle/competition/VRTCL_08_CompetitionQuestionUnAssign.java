...
import ir.khalili.products.odds.core.biz.competition.Biz_08_CompetitionQuestionUnAssign;
import ir.khalili.products.odds.core.constants.AppConstants;
import ir.khalili.products.odds.core.utils.Configuration;

public class VRTCL_08_CompetitionQuestionUnAssign extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_08_CompetitionQuestionUnAssign.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_COMPETITION_QUESTION_UNASSIGN, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_COMPETITION_QUESTION_UNASSIGN+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_08_CompetitionQuestionUnAssign.questionUnAssign(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_COMPETITION_QUESTION_UNASSIGN+" ready to reply.");
