...
import ir.khalili.products.odds.core.biz.competition.Biz_09_CompetitionQuestionFetch;
import ir.khalili.products.odds.core.constants.AppConstants;
import ir.khalili.products.odds.core.utils.Configuration;

public class VRTCL_09_CompetitionQuestionFetch extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_09_CompetitionQuestionFetch.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_COMPETITION_QUESTION_FETCH, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_COMPETITION_QUESTION_FETCH+" recieved with message:"+((JsonObject)(message.body())));
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_COMPETITION_QUESTION_FETCH+" ready to reply.");
