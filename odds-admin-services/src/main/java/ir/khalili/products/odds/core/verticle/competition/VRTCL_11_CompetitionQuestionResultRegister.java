...
import ir.khalili.products.odds.core.biz.competition.Biz_11_CompetitionQuestionResultRegister;
import ir.khalili.products.odds.core.constants.AppConstants;
import ir.khalili.products.odds.core.utils.Configuration;

public class VRTCL_11_CompetitionQuestionResultRegister extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_11_CompetitionQuestionResultRegister.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_COMPETITION_QUESTION_RESULT_REGISTER, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_COMPETITION_QUESTION_RESULT_REGISTER+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_11_CompetitionQuestionResultRegister.questionResultRegister(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_COMPETITION_QUESTION_RESULT_REGISTER+" ready to reply.");
