...
import ir.khalili.products.odds.core.biz.folder.Biz_02_FolderUpdate;
...
public class VRTCL_02_FolderUpdate extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_02_FolderUpdate.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_FOLDER_UPDATE, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_FOLDER_UPDATE+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_02_FolderUpdate.createAccount(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_FOLDER_UPDATE+" ready to reply.");
