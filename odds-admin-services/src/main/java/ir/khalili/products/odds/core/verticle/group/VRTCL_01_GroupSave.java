...
import ir.khalili.products.odds.core.biz.group.Biz_01_GroupSave;
...
public class VRTCL_01_GroupSave extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_01_GroupSave.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_GROUP_SAVE, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_GROUP_SAVE+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_01_GroupSave.createAccount(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_GROUP_SAVE+" ready to reply.");
