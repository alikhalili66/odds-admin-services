...
public class VRTCL_05_GroupFetchById extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_05_GroupFetchById.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_GROUP_ID_FETCH, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_GROUP_ID_FETCH+" recieved with message:"+((JsonObject)(message.body())));
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_GROUP_ID_FETCH+" ready to reply.");
