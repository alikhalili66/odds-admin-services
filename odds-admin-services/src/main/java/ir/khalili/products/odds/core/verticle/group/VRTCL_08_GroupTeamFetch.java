...
import ir.khalili.products.odds.core.biz.group.Biz_08_GroupTeamFetch;
...
public class VRTCL_08_GroupTeamFetch extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_08_GroupTeamFetch.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_GROUP_TEAM_FETCH, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_GROUP_TEAM_FETCH+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_08_GroupTeamFetch.createAccount(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_GROUP_TEAM_FETCH+" ready to reply.");
