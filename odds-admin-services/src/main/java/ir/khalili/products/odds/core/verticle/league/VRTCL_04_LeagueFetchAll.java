...
import ir.khalili.products.odds.core.biz.league.Biz_04_LeagueFetchAll;
...
public class VRTCL_04_LeagueFetchAll extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_04_LeagueFetchAll.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_LEAGUE_ALL_FETCH, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_LEAGUE_ALL_FETCH+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_04_LeagueFetchAll.createAccount(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_LEAGUE_ALL_FETCH+" ready to reply.");
