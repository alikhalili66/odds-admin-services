...
import ir.khalili.products.odds.core.biz.league.Biz_05_LeagueFetchById;
...
public class VRTCL_05_LeagueFetchById extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_05_LeagueFetchById.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_LEAGUE_ID_FETCH, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_LEAGUE_ID_FETCH+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_05_LeagueFetchById.createAccount(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_LEAGUE_ID_FETCH+" ready to reply.");
