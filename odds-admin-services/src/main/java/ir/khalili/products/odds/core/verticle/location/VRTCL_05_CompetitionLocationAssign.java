package ir.khalili.products.odds.core.verticle.location;
...
import ir.khalili.products.odds.core.biz.location.Biz_05_CompetitionLocationAssign;
import ir.khalili.products.odds.core.constants.AppConstants;
import ir.khalili.products.odds.core.utils.Configuration;

public class VRTCL_05_CompetitionLocationAssign extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_05_CompetitionLocationAssign.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_COMPETITION_LOCATION_ASSIGN, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_COMPETITION_LOCATION_ASSIGN+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_05_CompetitionLocationAssign.questionAssign(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_COMPETITION_LOCATION_ASSIGN+" ready to reply.");
