...
import ir.khalili.products.odds.core.biz.question.Biz_01_QuestionSave;
...
public class VRTCL_01_QuestionSave extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_01_QuestionSave.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_QUESTION_SAVE, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_QUESTION_SAVE+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_01_QuestionSave.createAccount(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_QUESTION_SAVE+" ready to reply.");
