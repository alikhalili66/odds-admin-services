...
import ir.khalili.products.odds.core.biz.question.Biz_02_QuestionUpdate;
...
public class VRTCL_02_QuestionUpdate extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_02_QuestionUpdate.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_QUESTION_UPDATE, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_QUESTION_UPDATE+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_02_QuestionUpdate.createAccount(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_QUESTION_UPDATE+" ready to reply.");
