...
public class VRTCL_03_QuestionDelete extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_03_QuestionDelete.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_QUESTION_DELETE, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_QUESTION_DELETE+" recieved with message:"+((JsonObject)(message.body())));
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_QUESTION_DELETE+" ready to reply.");
