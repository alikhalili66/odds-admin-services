package ir.khalili.products.odds.core.verticle.question;
...
import ir.khalili.products.odds.core.biz.question.Biz_04_QuestionFetchAll;
...
public class VRTCL_04_QuestionFetchAll extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_04_QuestionFetchAll.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_QUESTION_ALL_FETCH, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_QUESTION_ALL_FETCH+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_04_QuestionFetchAll.createAccount(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_QUESTION_ALL_FETCH+" ready to reply.");
