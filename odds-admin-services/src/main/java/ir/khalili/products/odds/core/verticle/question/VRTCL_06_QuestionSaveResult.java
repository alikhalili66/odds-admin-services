 ...
 * Time: 3:29 PM
 */
public class VRTCL_06_QuestionSaveResult extends AbstractVerticle {

    private Logger logger = LogManager.getLogger(VRTCL_06_QuestionSaveResult.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
        ...
        try {
            ...
            vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_QUESTION_SAVE_RESULT, message -> {

                logger.trace("Event " + AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_QUESTION_SAVE_RESULT + " recieved with message:" + ((JsonObject) (message.body())));
            ...
            logger.info("Event Bus Handler " + AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_QUESTION_SAVE_RESULT + " ready to reply.");
