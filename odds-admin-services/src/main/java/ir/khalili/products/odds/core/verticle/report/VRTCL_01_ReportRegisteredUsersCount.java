...
public class VRTCL_01_ReportRegisteredUsersCount extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_01_ReportRegisteredUsersCount.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_REPORT_REGISTERED_USERS_COUNT, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_REPORT_REGISTERED_USERS_COUNT+" recieved with message:"+((JsonObject)(message.body())));
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_REPORT_REGISTERED_USERS_COUNT+" ready to reply.");
