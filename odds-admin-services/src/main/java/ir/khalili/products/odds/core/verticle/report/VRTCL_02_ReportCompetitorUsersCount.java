...
import ir.khalili.products.odds.core.biz.report.Biz_02_ReportCompetitorUsersCount;
import ir.khalili.products.odds.core.constants.AppConstants;
import ir.khalili.products.odds.core.utils.Configuration;

public class VRTCL_02_ReportCompetitorUsersCount extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_02_ReportCompetitorUsersCount.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_REPORT_COMPETITOR_USERS_COUNT, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_REPORT_COMPETITOR_USERS_COUNT+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_02_ReportCompetitorUsersCount.fetchCompetitorUsersCount(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_REPORT_COMPETITOR_USERS_COUNT+" ready to reply.");
