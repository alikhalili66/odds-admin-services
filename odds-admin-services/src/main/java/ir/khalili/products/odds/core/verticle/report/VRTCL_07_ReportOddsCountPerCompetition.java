...
import ir.khalili.products.odds.core.biz.report.Biz_07_ReportOddsCountPerCompetition;
import ir.khalili.products.odds.core.constants.AppConstants;
import ir.khalili.products.odds.core.utils.Configuration;

public class VRTCL_07_ReportOddsCountPerCompetition extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_07_ReportOddsCountPerCompetition.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_REPORT_ODDS_COUNT_PER_COMPETITION, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_REPORT_ODDS_COUNT_PER_COMPETITION+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_07_ReportOddsCountPerCompetition.fetchReportOddsCountPerCompetition(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_REPORT_ODDS_COUNT_PER_COMPETITION+" ready to reply.");
