...
import ir.khalili.products.odds.core.biz.report.Biz_09_ReportQuestionStatisticPerCompetition;
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_REPORT_QUESTION_STATISTIC_PER_COMPETITION, message -> {
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_09_ReportQuestionStatisticPerCompetition.fetchReportQuestionStatisticPerCompetition(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
