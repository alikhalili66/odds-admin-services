...
import ir.khalili.products.odds.core.biz.report.Biz_11_ReportCompetitionWithMaximumOdds;
import ir.khalili.products.odds.core.constants.AppConstants;
import ir.khalili.products.odds.core.utils.Configuration;

public class VRTCL_11_ReportCompetitionWithMaximumOdds extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_11_ReportCompetitionWithMaximumOdds.class);
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_REPORT_USERS_WITH_MAXIMUM_ODDS, message -> {
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_11_ReportCompetitionWithMaximumOdds.fetchReportCompetitionWithMaximumOdds(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
