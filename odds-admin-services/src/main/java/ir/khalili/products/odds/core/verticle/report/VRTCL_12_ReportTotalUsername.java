...
import ir.khalili.products.odds.core.biz.report.Biz_12_ReportTotalUsername;
import ir.khalili.products.odds.core.constants.AppConstants;
import ir.khalili.products.odds.core.utils.Configuration;

public class VRTCL_12_ReportTotalUsername extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_12_ReportTotalUsername.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_REPORT_TOTAL_USERNAME, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_REPORT_TOTAL_USERNAME+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_12_ReportTotalUsername.fetchReport(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_REPORT_TOTAL_USERNAME+" ready to reply.");
