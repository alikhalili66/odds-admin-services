...
import ir.khalili.products.odds.core.biz.team.Biz_02_TeamUpdate;
...
public class VRTCL_02_TeamUpdate extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_02_TeamUpdate.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_TEAM_UPDATE, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_TEAM_UPDATE+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_02_TeamUpdate.createAccount(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_TEAM_UPDATE+" ready to reply.");
