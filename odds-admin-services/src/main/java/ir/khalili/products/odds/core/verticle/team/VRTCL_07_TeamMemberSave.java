...
import ir.khalili.products.odds.core.biz.team.Biz_07_TeamMemberSave;
import ir.khalili.products.odds.core.constants.AppConstants;
import ir.khalili.products.odds.core.utils.Configuration;

public class VRTCL_07_TeamMemberSave extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_07_TeamMemberSave.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_TEAM_MEMBER_SAVE, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_TEAM_MEMBER_SAVE+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_07_TeamMemberSave.save(vertx, sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_TEAM_MEMBER_SAVE+" ready to reply.");
