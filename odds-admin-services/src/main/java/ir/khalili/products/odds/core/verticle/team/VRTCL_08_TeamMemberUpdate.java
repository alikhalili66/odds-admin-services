...
import ir.khalili.products.odds.core.biz.team.Biz_08_TeamMemberUpdate;
import ir.khalili.products.odds.core.constants.AppConstants;
import ir.khalili.products.odds.core.utils.Configuration;

public class VRTCL_08_TeamMemberUpdate extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_08_TeamMemberUpdate.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_TEAM_MEMBER_UPDATE, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_TEAM_MEMBER_UPDATE+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_08_TeamMemberUpdate.update(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_TEAM_MEMBER_UPDATE+" ready to reply.");
