...
import ir.khalili.products.odds.core.biz.team.Biz_09_TeamMemberDelete;
import ir.khalili.products.odds.core.constants.AppConstants;
import ir.khalili.products.odds.core.utils.Configuration;

public class VRTCL_09_TeamMemberDelete extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_09_TeamMemberDelete.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_TEAM_MEMBER_DELETE, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_TEAM_MEMBER_DELETE+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_09_TeamMemberDelete.delete(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_TEAM_MEMBER_DELETE+" ready to reply.");
