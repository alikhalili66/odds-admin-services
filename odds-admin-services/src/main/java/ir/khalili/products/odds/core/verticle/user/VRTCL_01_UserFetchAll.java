...
public class VRTCL_01_UserFetchAll extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_01_UserFetchAll.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_USER_ALL_FETCH, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_USER_ALL_FETCH+" recieved with message:"+((JsonObject)(message.body())));
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_USER_ALL_FETCH+" ready to reply.");
