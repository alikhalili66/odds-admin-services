package ir.khalili.products.odds.core.verticle.user;
...
import ir.khalili.products.odds.core.biz.user.Biz_04_UserFetchQuestionAnswer;
import ir.khalili.products.odds.core.constants.AppConstants;
import ir.khalili.products.odds.core.utils.Configuration;

public class VRTCL_04_UserFetchQuestionAnswer extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_04_UserFetchQuestionAnswer.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_USER_QUESTION_FETCH, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_USER_QUESTION_FETCH+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_04_UserFetchQuestionAnswer.fetchQuestionAnswer(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_USER_QUESTION_FETCH+" ready to reply.");
