...
import ir.khalili.products.odds.core.biz.user.Biz_06_UserEditNikeName;
import ir.khalili.products.odds.core.constants.AppConstants;
import ir.khalili.products.odds.core.utils.Configuration;

public class VRTCL_06_UserEditNikeName extends AbstractVerticle {
	private Logger logger = LogManager.getLogger(VRTCL_06_UserEditNikeName.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
    	...
    	try {
        	...
        	vertx.eventBus().consumer(AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_USER_EDIT_NIKENAME, message -> {
        		
        		logger.trace("Event "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_USER_EDIT_NIKENAME+" recieved with message:"+((JsonObject)(message.body())));
        		...
        		ircJDBC.getConnection(connection -> {
					...
					Biz_06_UserEditNikeName.doEdit(sqlConnection, (JsonObject)(message.body()), resultHandler -> {
        	...
        	logger.info("Event Bus Handler "+AppConstants.EVNT_BUS_ADR_SRVCS_ODDS_USER_EDIT_NIKENAME+" ready to reply.");
