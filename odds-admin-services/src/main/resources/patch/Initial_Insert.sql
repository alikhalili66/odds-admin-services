...
insert into toppconfig (ID,NAME,SYMBOL,VALUE,TYPE,LEAGUE_ID) values(soppconfig.nextval,'شناسه بسته برنزی','PRODUCT_BRONZE_PACKAGE',10,'Number',1);
insert into toppconfig (ID,NAME,SYMBOL,VALUE,TYPE,LEAGUE_ID) values(soppconfig.nextval,'شناسه بسته نقره ای','PRODUCT_SILVER_PACKAGE',50,'Number',1);
